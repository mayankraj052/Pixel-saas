  ...
  return (
    <div
      ...
      className={` relative backdrop-blur-lg border rounded-3xl p-8 transition-all duration-700 cursor-pointer 
        ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 transform-y-10"} ${isHovered ? "transform scale-115 rotate-1 shadow-2xl" : ""}
        ${featured ? "bg-gradient-to-b from-blue-500/20 to-purple-600/20 border-blue-400/50 scale-105" : "bg-white/5 border-white/10 "}`}
...
const Pricing = () => {
  const plans = [
    ...
    },
    {
      ...
      featured: true,
      planId: "cplan_32HIsncs7c6oXQhfxqU0prMD2gr",
